 ...
 *****************************************************/
    $(function(){
        ...
        $("#typed").typed({
            strings: ["<span>Memorable experiences for web interfaces.</span>", "<span>Your technology partner on the road to success.</span>", "<span>Creating websites that have it all: Beauty and brains.</span>",],
            typeSpeed: 80,
            backDelay: 500,
            loop: true,
