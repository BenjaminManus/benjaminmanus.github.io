...
//*********************Google MAP *********************/
		...
		var saturation = 100 // 
		var mapLatitude=41.8230559 
		var mapLongitude=-72.8874371//(Fist Value Latitude, Second Value ), get YOUR coordenates here!: http://itouchmap.com/latlong.html
		var mapZoom_value=16 // Map zoom level parameter only numeric  


// Google map marker example 2 locations 
		//map-marker #1
		var marker1_Latitude=41.8230559
		var marker1_Longitude=-72.8874371
		var marker1_content="<h2>Benjamin</h2> Canton, CT" // marker or  on click content (Info Window) 
